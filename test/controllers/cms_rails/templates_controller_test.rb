  ...
  class TemplatesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create template" do
      assert_difference("Template.count") do
        post templates_url, params: { template: { category_id: @template.category_id, file_path: @template.file_path, name: @template.name } }
      end
    ...
    test "should update template" do
      patch template_url(@template), params: { template: { category_id: @template.category_id, file_path: @template.file_path, name: @template.name } }
